  ...
  switch (suffix) {
    ...
    case "de":
      if (
        ...
        in_array(lastLetter, hardConsonantLetters) &&
        (lastVowelLetter == "a" ||
          lastVowelLetter == "ı" ||
          lastVowelLetter === "u" ||
          lastVowelLetter === "o")
...
export const TurkishSuffixPlugin = {
  install() {
    String.prototype.toTurkishSuffix = function (suffix) {
      return suffixes(this, suffix, true, "'");
    };
  },
};
